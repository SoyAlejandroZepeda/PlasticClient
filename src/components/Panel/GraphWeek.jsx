...
import { GET_DEPARTMENT, GET_WEEK } from '../Queries';

//Styles
import '../../styles.css';

class GraphWeek extends Component {
    state = {  }
    render() { 
        ...
        return ( 
            <Fragment>
                <h2 className="text-center mb-3">Gráfica de movilidad semanal</h2>
                    ...
                    return(
                        <Fragment>
                            ...
                            {({loading, error, data}) => {
                                if(loading) return 'Loading...';
                                if(error) return `Error: ${error.message}`;
                                const dataWeek = data.getWeek;
                                return(
                                    <h4 className="text-center mb-5 font-italic"> {dataDepartment.departmentName} - SEMANA {dataWeek.week} </h4>
                                )
                            }}
